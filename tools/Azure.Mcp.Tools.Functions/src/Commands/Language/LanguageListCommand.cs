...
public sealed class LanguageListCommand(ILogger<LanguageListCommand> logger) : BaseCommand<EmptyOptions>
{
    ...
    public override string Description =>
        ...
        "Call this tool when users ask which languages Azure Functions supports, want to compare language options, or need to choose a language for a new project. " +
        "Also call this tool as a first step before generating any Azure Functions code to confirm the correct language and runtime version. " +
