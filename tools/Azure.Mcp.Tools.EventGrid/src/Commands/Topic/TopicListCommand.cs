...
public sealed class TopicListCommand(ILogger<TopicListCommand> logger) : BaseEventGridCommand<TopicListOptions>
{
    ...
    public override string Description => "List all Event Grid topics in my subscription or a specific subscription with detailed configuration and status information. Can filter by resource group to show topics in a specific resource group. This tool retrieves comprehensive topic details including endpoints, access keys, provisioning state, and subscription information for event publishing and management. Shows Event Grid topic details and configuration in JSON format. Use this to show, list, or get Event Grid topics. Requires subscription access and returns topic information as a structured array.";
